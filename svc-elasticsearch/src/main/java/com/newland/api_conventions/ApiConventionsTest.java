...
public class ApiConventionsTest {
    ...
    public void blockingAndAsync() throws Exception {
        ...
        ElasticsearchClient client = new ElasticsearchClient(ElasticsearchClientUtils.getTransport());
        ...
        ElasticsearchAsyncClient asyncClient =
            new ElasticsearchAsyncClient(ElasticsearchClientUtils.getTransport());
    ...
    public void customVariants() throws Exception {
        ElasticsearchTransport transport=ElasticsearchClientUtils.getTransport();
